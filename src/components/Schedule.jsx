    ...
    1: [
      {
        time: "09:00 AM",
        sport: "Cricket",
        match: "Round 1: Team A vs Team B",
        venue: "Main Ground",
        tag: "Water",
      },
      {
        ...
        <div className="text-center mb-16 relative">
          <ParallaxElement speed={-0.1} direction="up">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-prakida-water font-bold tracking-[0.2em] mb-4">
                TIMELINE
              </h2>
        ...
        <div className="relative flex justify-center gap-4 mb-12">
          ...
          {[
            ...
            <button
              ...
              className={`px-4 py-2 md:px-8 md:py-3 font-display font-bold text-sm md:text-lg tracking-wider transition-all duration-300 border-b-2 group relative z-10 bg-prakida-bg ${
                activeDay === day.id
            ...
            >
              ...
              <span
                className={`text-[10px] md:text-xs block mt-1 tracking-widest ${activeDay === day.id ? "text-prakida-flame" : "text-gray-600 group-hover:text-gray-500"}`}
              >
                {day.sub}
              </span>
            </button>
              ...
              {scheduleData[activeDay].map((item, idx) => (
                ...
                >
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h4 className="text-xl font-bold text-white font-display group-hover:text-prakida-flame transition-colors">
                      {item.sport}
                    </h4>
