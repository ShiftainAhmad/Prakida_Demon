  ...
  const sponsors = [
    {
      ...
      image:
        "https://ui-avatars.com/api/?name=Aditya+Sharma&background=F48C06&color=fff",
    },
    {
      id: 2,
      name: "Priya Patel",
      ...
      image:
        "https://ui-avatars.com/api/?name=Priya+Patel&background=F48C06&color=fff",
    },
    {
      id: 3,
      name: "Rahul Verma",
      ...
      image:
        "https://ui-avatars.com/api/?name=Rahul+Verma&background=F48C06&color=fff",
    },
  ];
    ...
    <div className="pt-24 min-h-screen container mx-auto px-4 pb-20">
      ...
      >
        ...
        <p className="text-xl text-gray-400 font-sans max-w-2xl mx-auto">
          Honoring our past, building our future. Connect with the legacy of
          Prakida and support the next generation.
        </p>
      </motion.div>
          ...
          {sponsors.map((sponsor, index) => (
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                />
                <div>
                  <h3 className="text-xl font-bold text-white group-hover:text-prakida-flame transition-colors">
                    {sponsor.name}
                  </h3>
                  <p className="text-sm text-gray-400">
                    Class of {sponsor.batch}
                  </p>
                </div>
              </div>
              <div className="mb-4">
